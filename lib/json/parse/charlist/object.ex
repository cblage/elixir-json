defmodule JSON.Parse.Charlist.Object do
  ...
  ## Examples
      ...
      iex> JSON.Parse.Charlist.Object.parse ''
      {:error, :unexpected_end_of_buffer}

      iex> JSON.Parse.Charlist.Object.parse 'face0ff'
      ...
      iex> JSON.Parse.Charlist.Object.parse '{"result": "this will be a elixir result"} lalal'
  ...
  defp parse_object_key(json) when is_list(json) do
    case JSON.Parse.Charlist.String.parse(json) do
  ...
  defp parse_object_value(acc, key, after_key) do
    case JSON.Parse.Charlist.parse(after_key) do
      { :error, error_info} -> { :error, error_info }
